...
class YOLO(object):
    _defaults = {
        "model_path": 'logs/000/ep001-loss13.444-val_loss11.188.h5',
    ...
    def detect_image_without_drawing(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            # add everything to list
            ObjectsList.append([left, top, right, bottom, mid_v, mid_h, c, scores])
